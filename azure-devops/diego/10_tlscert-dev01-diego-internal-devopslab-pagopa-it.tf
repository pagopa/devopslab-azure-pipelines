...
module "tlscert-diego-itn-internal-devopslab-pagopa-it-cert_az" {
  ...
  name       = "${var.tlscert-diego-itn-internal-devopslab-pagopa-it.pipeline.dns_record_name}.${var.tlscert-diego-itn-internal-devopslab-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:general-secrets-no-plaintext-exposure
  #tfsec:ignore:GEN003
  renew_token                  = local.tlscert_renew_token
  path                         = "${local.domain}\\${var.tlscert-diego-itn-internal-devopslab-pagopa-it.pipeline.path}"
  ...
  dns_zone_resource_group = local.tlscert-diego-itn-internal-devopslab-pagopa-it.dns_zone_resource_group
  ...
  credential_subcription              = local.tlscert-diego-itn-internal-devopslab-pagopa-it.credential_subcription
  credential_key_vault_name           = local.tlscert-diego-itn-internal-devopslab-pagopa-it.credential_key_vault_name
  credential_key_vault_resource_group = local.tlscert-diego-itn-internal-devopslab-pagopa-it.credential_key_vault_resource_group
  ...
  service_connection_ids_authorization = local.tlscert-diego-itn-internal-devopslab-pagopa-it.service_connection_ids_authorization
  ...
  schedules = {
    ...
    branch_filter = {
      include = [var.tlscert-diego-itn-internal-devopslab-pagopa-it.repository.branch_name]
      exclude = []
    }
  }
