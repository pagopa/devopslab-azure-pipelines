...
module "UAT-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN" {
  ...
  subscription_id   = module.secret_core.values["PAGOPAIT-UAT-CSTAR-SUBSCRIPTION-ID"].value
  #tfsec:ignore:GEN003
  renew_token = local.tlscert_renew_token
...
module "PROD-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN" {
  ...
  subscription_id   = module.secret_core.values["PAGOPAIT-PROD-CSTAR-SUBSCRIPTION-ID"].value
  #tfsec:ignore:GEN003
  renew_token = local.tlscert_renew_token
