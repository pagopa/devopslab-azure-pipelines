...
| <a name="module_tlscert-mock-itn-internal-devopslab-pagopa-it-cert_az"></a> [tlscert-mock-itn-internal-devopslab-pagopa-it-cert\_az](#module\_tlscert-mock-itn-internal-devopslab-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v8.0.0 |
| <a name="module_tlscert-testit-itn-internal-devopslab-pagopa-it-cert_az"></a> [tlscert-testit-itn-internal-devopslab-pagopa-it-cert\_az](#module\_tlscert-testit-itn-internal-devopslab-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | fix-cert-pipeline-definition |
