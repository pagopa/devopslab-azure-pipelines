...
#       enable_deploy        = true
#       path                 = "diego-infrastructure"
#       pipeline_name_prefix = "diego-infra"
#     }
#   }
# }
...
#   # global vars
#   diego_iac_variables = {
#     tf_dev_aks_apiserver_url         = module.diego_dev_secrets.values["pagopa-d-weu-dev-aks-apiserver-url"].value,
#     tf_dev_aks_azure_devops_sa_cacrt = module.diego_dev_secrets.values["pagopa-d-weu-dev-aks-azure-devops-sa-cacrt"].value,
#     tf_dev_aks_azure_devops_sa_token = base64decode(module.diego_dev_secrets.values["pagopa-d-weu-dev-aks-azure-devops-sa-token"].value),
...
#     tf_uat_aks_apiserver_url         = module.diego_uat_secrets.values["pagopa-u-weu-uat-aks-apiserver-url"].value,
#     tf_uat_aks_azure_devops_sa_cacrt = module.diego_uat_secrets.values["pagopa-u-weu-uat-aks-azure-devops-sa-cacrt"].value,
#     tf_uat_aks_azure_devops_sa_token = base64decode(module.diego_uat_secrets.values["pagopa-u-weu-uat-aks-azure-devops-sa-token"].value),
...
#     tf_prod_aks_apiserver_url         = module.diego_prod_secrets.values["pagopa-p-weu-prod-aks-apiserver-url"].value,
#     tf_prod_aks_azure_devops_sa_cacrt = module.diego_prod_secrets.values["pagopa-p-weu-prod-aks-azure-devops-sa-cacrt"].value,
#     tf_prod_aks_azure_devops_sa_token = base64decode(module.diego_prod_secrets.values["pagopa-p-weu-prod-aks-azure-devops-sa-token"].value),
